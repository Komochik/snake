# Змейка на Java
Этот проект представляет собой компьютерную игру "Змейка" с реализацией отражения от стенок по законам света. Проект реализован на языке программирования Java с использованием библиотеки JavaFX для графического интерфейса. Система сборки использует Apache Maven.
